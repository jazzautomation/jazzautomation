...
set CLASSPATH=%APP_HOME%\lib\jazzautomation.jar;%APP_HOME%\lib\selenium-java-2.34.0.jar;%APP_HOME%\lib\selenium-client-factory-1.2.jar;%APP_HOME%\lib\jackson-mapper-asl-1.9.3.jar;%APP_HOME%\lib\logback-core-1.0.13.jar;%APP_HOME%\lib\logback-classic-1.0.13.jar;%APP_HOME%\lib\commons-exec-1.1.jar;%APP_HOME%\lib\jna-3.4.0.jar;%APP_HOME%\lib\platform-3.4.0.jar;%APP_HOME%\lib\json-20080701.jar;%APP_HOME%\lib\guava-14.0.jar;%APP_HOME%\lib\selenium-api-2.34.0.jar;%APP_HOME%\lib\cglib-nodep-2.1_3.jar;%APP_HOME%\lib\commons-codec-1.7.jar;%APP_HOME%\lib\commons-logging-1.1.1.jar;%APP_HOME%\lib\httpcore-4.2.2.jar;%APP_HOME%\lib\httpclient-4.2.3.jar;%APP_HOME%\lib\selenium-remote-driver-2.34.0.jar;%APP_HOME%\lib\selenium-android-driver-2.34.0.jar;%APP_HOME%\lib\selenium-chrome-driver-2.34.0.jar;%APP_HOME%\lib\xml-apis-1.4.01.jar;%APP_HOME%\lib\serializer-2.7.1.jar;%APP_HOME%\lib\xalan-2.7.1.jar;%APP_HOME%\lib\commons-collections-3.2.1.jar;%APP_HOME%\lib\commons-lang3-3.1.jar;%APP_HOME%\lib\httpmime-4.2.3.jar;%APP_HOME%\lib\htmlunit-core-js-2.12.jar;%APP_HOME%\lib\xercesImpl-2.10.0.jar;%APP_HOME%\lib\nekohtml-1.9.18.jar;%APP_HOME%\lib\sac-1.3.jar;%APP_HOME%\lib\cssparser-0.9.9.jar;%APP_HOME%\lib\jetty-util-8.1.9.v20130131.jar;%APP_HOME%\lib\jetty-io-8.1.9.v20130131.jar;%APP_HOME%\lib\jetty-http-8.1.9.v20130131.jar;%APP_HOME%\lib\jetty-websocket-8.1.9.v20130131.jar;%APP_HOME%\lib\commons-io-2.4.jar;%APP_HOME%\lib\htmlunit-2.12.jar;%APP_HOME%\lib\selenium-htmlunit-driver-2.34.0.jar;%APP_HOME%\lib\selenium-firefox-driver-2.34.0.jar;%APP_HOME%\lib\selenium-ie-driver-2.34.0.jar;%APP_HOME%\lib\selenium-iphone-driver-2.34.0.jar;%APP_HOME%\lib\netty-3.5.2.Final.jar;%APP_HOME%\lib\webbit-0.4.14.jar;%APP_HOME%\lib\selenium-safari-driver-2.34.0.jar;%APP_HOME%\lib\selenium-support-2.34.0.jar;%APP_HOME%\lib\selenium-java-client-driver-1.0.2.jar;%APP_HOME%\lib\jackson-core-asl-1.9.3.jar;%APP_HOME%\lib\slf4j-api-1.7.5.jar
